...
//             className="h-12 w-full rounded-2xl border border-slate-200 pl-11 pr-4 outline-none focus:border-blue-600"
//           />
...
//           <button className="flex items-center gap-2 rounded-2xl bg-slate-900 px-5 py-3 text-white">
